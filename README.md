...
# 교재 : 누구나 파이썬 통계분석 (타니아이 히로키,츠지 신고,권기태 / 한빛 아카데미)

<img src="https://github.com/juugii-ho/KDT_8W_Numpy/blob/master/B2049588591_l.jpg?raw=true" width="240" height="360"/> 

<br>
<br>

# [교육 내용](https://velog.io/@bbalgang/series/기록-Numpy)

 | **파일** | **날짜** | **내용** | **velog**|
 |:-----:|:-----:|:-----:|:------:|
 | 240216 | 24. 2. 16. | array, 통계, 히스토그램, 정규화, 시각화 | [velog link]( https://velog.io/@bbalgang/215-Numpy-1일차 ) |
 | 240219 | 24. 2. 19. | 공분산 및 상관계수, 회귀분석 | [velog link]( https://velog.io/@bbalgang/217-Numpy-2일차 ) |
 | 240220 | 24. 2. 20. | 확률분포, 확률함수, 이산형 확률분포, 연속형 확률분포 | [velog link]( https://velog.io/@bbalgang/220-Numpy-3일차 ) |
 | 240221 | 24. 2. 21. | 통계적 추정과 가설검정, 표본검정 | [velog link]( https://velog.io/@bbalgang/221-Numpy-4일차 ) |
